...
>
  ...
  <div
    class="relative -top-64 max-xl:-top-44 max-lg:-top-24 max-sm:-top-10 left-0 right-0 flex justify-center items-center flex-col z-10"
  >
    <img src={kingdoms} alt="banner" class=" w-[70%]" />
    <p class="text-white px-4 text-center text-xl mt-[0px] max-md:text-sm">
